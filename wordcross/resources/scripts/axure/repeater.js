...
$axure.internal(function($ax) {
    ...
    var _refreshRepeater = function(repeaterId, eventInfo) {
        ...
        if(shown) $ax.visibility.SetWidgetVisibility(repeaterId, { value: false });
        ...
        if(shown) $ax.visibility.SetWidgetVisibility(repeaterId, { value: true });
    ...
    _repeaterManager.hasData = function(id, propName) {
        ...
        return Boolean(repeaterToCurrentDataSet[repeaterId] && repeaterToCurrentDataSet[repeaterId][0] && repeaterToCurrentDataSet[repeaterId][0][propName]);
    };
